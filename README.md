...
You can send requests to the Write API using its Swagger at http://localhost:8090/producer/swagger-ui.html# after startup. The same can be done for the Read API at http://localhost:8092/consumer/swagger-ui.html#.
